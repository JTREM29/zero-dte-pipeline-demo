# Starts the polygon ingest loop in the background with environment variables loaded.
...
Write-Host "[RUN] Launching polygon ingest in a separate PowerShell window..."
