...
def main() -> None:
    ...
    try:
        r.set(fut_status_key(), json.dumps(boot_status, separators=(",", ":"), ensure_ascii=False))
        _write_hb(r, "boot")
    except Exception:
        pass
        ...
        try:
            ...
            if rec_type == "ErrorMsg" or hasattr(rec, "err"):
                ...
                try:
                    ...
                    r.set(fut_status_key(), json.dumps(st, separators=(",", ":"), ensure_ascii=False))
                except Exception:
                    pass
                return
    ...
    def _run_attempt(stype_in: str, *, break_on_boot_timeout: bool) -> None:
        ...
        try:
            r.set(fut_status_key(), json.dumps(attempt_boot, separators=(",", ":"), ensure_ascii=False))
            _write_hb(r, "boot")
        except Exception:
            pass
